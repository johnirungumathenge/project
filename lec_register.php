...
<body>
    <div class="container">
            <div class="form-class text-light">
                <h1 class="text-center text-dark p-2">Admin Signup Form</h1>
        ...
        if(isset($_POST['submit'])){
            ...
            if(count($errors) >0){
                ...
                $sql = "INSERT INTO Lecturers (fullname, email, password)  VALUES(?,?,?)";
        ...
        ?>
        <form method="POST" action="lec_register.php">
        ...
        <p class="text-center p-2 m-3">Registered?<a class="text-decoration-none p-3" href="lecturer_login.php">  Login here</a></p>
    </div>
